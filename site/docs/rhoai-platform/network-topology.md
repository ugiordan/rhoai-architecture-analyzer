...
46 Kubernetes services across the platform.
...
- **8080/TCP**: pypi-server, kuberay-operator, service, model-catalog, modelmesh-controller, maas-api, workspaces-controller-metrics-service, workspaces-frontend, training-operator
