...
63 Kubernetes services across the platform.
...
- **443/TCP**: kserve-webhook-server-service, llmisvc-webhook-server-service, localmodel-webhook-server-service, webhook-service, kserve-webhook-server-service, llmisvc-webhook-server-service, localmodel-webhook-server-service, service, webhook-service, visibility-server, webhook-service, istiod-llm-d-gateway, model-registry-operator-webhook-service, workspaces-webhook-service, model-serving-api, odh-model-controller-webhook-service, webhook-service, spark-operator-webhook-svc, training-operator, webhook-service
...
- **8033/TCP**: model-mesh
- **8080/TCP**: data-science-pipelines-operator-service, pypi-server, service, model-catalog, modelmesh-controller, maas-api, workspaces-controller-metrics-service, workspaces-frontend, model-serving-api, training-operator, trustyai-service-operator-metrics-service, kuberay-operator
