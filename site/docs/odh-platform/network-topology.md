...
51 Kubernetes services across the platform.
...
- **8080/TCP**: data-science-pipelines-operator-service, pypi-server, kuberay-operator, service, model-catalog, modelmesh-controller, maas-api, workspaces-controller-metrics-service, workspaces-frontend, model-serving-api, trustyai-service-operator-metrics-service
- **8443/TCP**: ml-pipeline, template-value, kserve-controller-manager-metrics-service, kserve-controller-manager-service, llmisvc-controller-manager-service, llama-stack-k8s-operator-controller-manager-metrics-service, mlflow-operator-controller-manager-metrics-service, odh-dashboard, trustyai-service-operator-controller-manager-metrics-service
