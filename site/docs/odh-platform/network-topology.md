...
56 Kubernetes services across the platform.
...
- **443/TCP**: webhook-service, kserve-webhook-server-service, llmisvc-webhook-server-service, localmodel-webhook-server-service, service, webhook-service, webhook-service, visibility-server, webhook-service, istiod-llm-d-gateway, model-registry-operator-webhook-service, workspaces-webhook-service, model-serving-api, odh-model-controller-webhook-service, webhook-service, spark-operator-webhook-svc, training-operator
