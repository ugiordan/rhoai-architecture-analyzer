...
|------------|-----------|--------------|------------|------------|--------|
| trustyai-service-operator-controller-manager | manager | true | ? | ? | [`kustomize:config/overlays/odh`](https://github.com/red-hat-data-services/trustyai-service-operator/blob/6b52d04c51b89713876a2f783e3dd0729ad34065/kustomize:config/overlays/odh) |
