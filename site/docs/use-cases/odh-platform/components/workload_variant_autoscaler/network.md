...
| keda-operator | ClusterIP | 9666/TCP, 8080/TCP | [`.gomod-cache/github.com/kedacore/keda/v2@v2.18.0/config/manager/service.yaml`](https://github.com/llm-d/workload-variant-autoscaler/blob/fb7f5c6afd8a71201656c1ef69c5385487032501/.gomod-cache/github.com/kedacore/keda/v2@v2.18.0/config/manager/service.yaml) |
