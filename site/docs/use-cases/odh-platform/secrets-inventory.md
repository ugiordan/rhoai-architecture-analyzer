...
54 secrets referenced across the platform. No secret values are extracted, only names, types, and which component references them.
...
<div style="display: flex; align-items: center; gap: 8px;">
  <span style="min-width: 220px; text-align: right; font-size: 0.85em; white-space: nowrap;">distributed-workloads</span>
  <div style="flex: 1; background: var(--md-default-fg-color--lightest); border-radius: 4px; height: 22px; position: relative;">
...
<div style="display: flex; align-items: center; gap: 8px;">
  ...
  <div style="flex: 1; background: var(--md-default-fg-color--lightest); border-radius: 4px; height: 22px; position: relative;">
    <div style="width: 90%; background: #27ae60; height: 100%; border-radius: 4px; min-width: 20px;"></div>
  </div>
  <span style="min-width: 30px; font-size: 0.85em; font-weight: 600;">9</span>
</div>
<div style="display: flex; align-items: center; gap: 8px;">
...
| distributed-workloads | 0 | 3 | 3 |
| kserve | 0 | 10 | 10 |
| kserve-autogluon-server | 0 | 9 | 9 |
| kubeflow | 1 | 1 | 2 |
| kuberay | 0 | 1 | 1 |
| kueue | 0 | 3 | 3 |
| llama-stack-k8s-operator | 0 | 1 | 1 |
| llm-d-inference-scheduler | 0 | 3 | 3 |
| mlflow-operator | 0 | 2 | 2 |
| model-registry | 0 | 3 | 3 |
| modelmesh-serving | 0 | 2 | 2 |
| models-as-a-service | 1 | 0 | 1 |
| spark-operator | 0 | 1 | 1 |
| trainer | 0 | 2 | 2 |
| workload-variant-autoscaler | 0 | 5 | 5 |
...
### kserve-autogluon-server (9 secrets)
...
- **Webhook certs** are the dominant secret type (37 of 54 secrets).
