...
- **80/TCP**: minio-template-value, kubeflow-pipelines-profile-controller, cli-port-default
- **8080/TCP**: data-science-pipelines-operator-service, pypi-server, modelmesh-controller
- **8443/TCP**: ml-pipeline, template-value, kserve-controller-manager-metrics-service, kserve-controller-manager-service, llmisvc-controller-manager-service
