...
75 Kubernetes services across the platform.
...
| kserve | 8 | 4 | 3 | 1 |
| kserve-autogluon-server | 7 | 3 | 3 | 1 |
...
| model-registry-operator | 3 | 1 | 1 | 1 |
| modelmesh | 1 | 0 | 0 | 1 |
...
### kserve-autogluon-server (7 services)
...
### model-registry-operator (3 services)
...
| disagg_prefill_proxy_server-server | python-source | 8000/TCP |
...
- **443/TCP**: webhook-service, kserve-webhook-server-service, llmisvc-webhook-server-service, localmodel-webhook-server-service, webhook-service, service, webhook-service, webhook-service, visibility-server, webhook-service, istiod-llm-d-gateway, model-registry-operator-webhook-service, workspaces-webhook-service, model-serving-api, odh-model-controller-webhook-service, kserve-webhook-server-service, llmisvc-webhook-server-service, localmodel-webhook-server-service, spark-operator-webhook-svc, training-operator
- **5432/TCP**: postgres-service
- **5557/TCP**: ${EPP_NAME}, e2e-epp
- **80/TCP**: minio-template-value, kubeflow-pipelines-profile-controller, inference-gateway-istio-nodeport, cli-port-default, cli-port-default
- **8000/TCP**: cli-port-default, cli-port-default, disagg_prefill_proxy_server-server
- **8033/TCP**: model-mesh
- **8080/TCP**: data-science-pipelines-operator-service, pypi-server, kuberay-operator, service, model-catalog, modelmesh-controller, maas-api, workspaces-controller-metrics-service, workspaces-frontend, model-serving-api, trustyai-service-operator-metrics-service, training-operator
- **8081/TCP**: cli-port-default
- **8443/TCP**: ml-pipeline, template-value, kserve-controller-manager-metrics-service, kserve-controller-manager-service, llmisvc-controller-manager-service, kube-rbac-proxy, kube-rbac-proxy, llama-stack-k8s-operator-controller-manager-metrics-service, mlflow-operator-controller-manager-metrics-service, model-registry-operator-controller-manager-metrics-service, odh-dashboard, kserve-controller-manager-metrics-service, kserve-controller-manager-service, llmisvc-controller-manager-service, trustyai-service-operator-controller-manager-metrics-service
