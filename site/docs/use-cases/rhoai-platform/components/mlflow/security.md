...
| `docker/Dockerfile` | python:3.10-slim-bullseye | 1 |  |  |  |  | No USER directive found (defaults to root) |
| `docker/Dockerfile.full` | python:3.10-slim-bullseye | 1 |  |  |  |  | No USER directive found (defaults to root) |
| `docker/Dockerfile.full.dev` | python:3.10-slim-bullseye | 1 |  |  |  |  | No USER directive found (defaults to root) |
